...
const MODULE_TITLES: Record<ModuleType, { title: string; subtitle: string }> = {
  ...
  'pattern-awareness': { title: 'LEGA Pattern Awareness', subtitle: 'Mengenali pola berulang pikiran, emosi, sensasi tubuh, dan respons hidup' },
  ...
  'audio-ai': { title: 'Audio AI & Relaksasi', subtitle: 'Pendengaran terpandu, lanskap suara alam, dan narasi audio menenangkan' },
